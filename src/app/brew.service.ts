...
export class BrewService {
  ...
  getBrews (): Observable<Brew[]> {
    return this.http.get<Brew[]>(`${this.brewsUrl}?func=GET`)
      .pipe(
  ...
  getIngredients(id: number): Observable<Ingredient[]> {
    return this.http.get<Ingredient[]>(`${this.ingredientsUrl}?id=${id}`)
      .pipe(
  ...
  getBrew(id: number): Observable<Brew> {
    const url = `${this.brewsUrl}?func=GET&id=${id}`;
  ...
  searchBrews(term: string): Observable<Brew[]> {
    ...
    return this.http.get<Brew[]>(`${this.brewsUrl}/?func=SEARCH&name=${term}`).pipe(
  ...
  /** POST: add a new hero to the server */
  addIngredient (ingredient: Ingredient, brew_id: number): Observable<Ingredient> {
    //const url = `https://pawelwnuk.pl/brew/api/brew_details.php?action=write&method=insert&name=${brew.name}`;
    //console.log(ingredient);
    return this.http.post<Ingredient>(`${this.ingredientsUrl}?id=${brew_id}`, ingredient, httpOptions).pipe(
